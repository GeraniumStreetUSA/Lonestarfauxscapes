---
title: "Texas fire code requirements for artificial plants in commercial buildings"
summary: "How Texas fire codes apply to artificial greenery in commercial buildings—which codes Texas adopts, how occupancy types affect requirements, what the AHJ expects, and how to avoid problems during inspection."
date: 2026-04-02
...
Texas uses model codes published by the [International Code Council (ICC)](https://www.iccsafe.org/) as its base building and fire codes:
...
**IBC Chapter 8 — Interior Finishes.** This chapter sets requirements for materials applied to walls, ceilings, and floors based on the building's occupancy type and sprinkler status. Interior finishes are required to be tested per [ASTM E84](https://www.astm.org/e0084-24.html) (or UL 723) and classified as Class A, B, or C based on their flame spread and smoke development characteristics.

**IFC Chapter 8 — Interior Furnishings and Decorative Materials.** This chapter addresses decorative vegetation, curtains, draperies, and other decorative materials in commercial spaces. It references [NFPA 701](https://www.nfpa.org/codes-and-standards/nfpa-701-standard-development/701) as the applicable test standard for flame propagation of decorative materials.
...
In most installations, artificial living walls and hedge panels are treated as decorative materials, making NFPA 701 the more commonly referenced standard. For a detailed comparison of the two standards, see our [NFPA 701 vs ASTM E84 guide](/blog/2026-02-21-nfpa-701-vs-astm-e84-fire-ratings-for-artificial-greenery).

## How occupancy type affects requirements

The IBC classifies buildings by occupancy type, and each type has different levels of fire code scrutiny. For artificial greenery, the key occupancy types are:
...
- Interior common areas in hotels and multifamily buildings (lobbies, hallways, amenity spaces)
- Restaurant and bar interiors and covered patios
- High-rise balconies and common areas
- Spaces along egress paths (near exits, stairwells, corridors)
- Interior walls in assembly occupancies

**May require documentation depending on the AHJ:**
- Covered patios and semi-enclosed outdoor spaces
- Decorative elements near cooking equipment or heating sources
- Large-scale installations that cover significant wall area

**Typically not required but still smart:**
- Fully exterior fence-line installations
- Residential backyard installations
- Small accent pieces in business offices
...
For a complete documentation checklist, see our [fire-rated artificial greenery guide for commercial properties](/blog/2026-02-21-fire-rated-artificial-greenery-for-texas-commercial-properties).
...
- [NFPA 701 vs ASTM E84: fire ratings explained](/blog/2026-02-21-nfpa-701-vs-astm-e84-fire-ratings-for-artificial-greenery)
- [Firewise artificial hedges for multifamily properties](/blog/2026-02-03-firewise-artificial-hedges-for-multi-family-units)

For fire-rated products, see our [fire-rated artificial hedge page](/fire-rated-artificial-hedge) or [Vallum FRX system](/vallum-frx).
...
- ASTM E84: https://www.astm.org/e0084-24.html
